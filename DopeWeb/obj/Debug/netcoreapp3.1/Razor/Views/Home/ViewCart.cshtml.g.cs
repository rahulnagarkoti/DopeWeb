#pragma checksum "C:\Users\nagar\Desktop\My Projects\DopeWeb\DopeWeb\Views\Home\ViewCart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a884d39f3df6c44357e423f2aad7b1e1fea8ddc4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a884d39f3df6c44357e423f2aad7b1e1fea8ddc4", @"/Views/Home/ViewCart.cshtml")]
...
<script>
                ...
                success: function (result) {
                    $.each(result, function (k, v) {
                        ...
                        html = html + `<tr id=${id}>
                              ...
                              <td> <img src=""../product-images/${image}"" class=""img-cart"" alt=""Imag");
            WriteLiteral(@"e""></td >
                              <td>${name}</td>
                ...
                complete: function (e) {
                    ...
                    {
                  ");
            WriteLiteral(@"      $(""#tableBody"").append(html);
                    }
                }
            });
    ...
    function updateTotalPrice() {
        ...
        if (totalPrice == 0)
        {
            $(""#tableBody"").html(""<p style='text-align:cent");
            WriteLiteral(@"er;'> <b>No items to display.</b></p>"");
        }
    }
